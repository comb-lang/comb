...
foreign Kernel32 {
    ...
    CreateFileMappingW :: proc(hFile: rawptr, lpFileMappingAttributes: rawptr, flProtect: u32, dwMaximumSizeHigh: u32, dwMaximumSizeLow: u32, lpName: cstring16) -> rawptr ---

    MapViewOfFile :: proc(hFileMappingObject: rawptr, dwDesiredAccess: u32, dwFileOffsetHigh: u32, dwFileOffsetLow: u32, dwNumberOfBytesToMap: uint) -> rawptr ---
